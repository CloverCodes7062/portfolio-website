    ...
    return (
        <div className="left-container">
            ...
            <div className='logo-container'>
                <a href="https://github.com/CloverCodes7062" target="_blank" className='github-logo-link'>
                    <svg className='git-logo' 
                        width="98" height="96"
                        transform="scale(0.33)"
                        xmlns="http://www.w3.org/2000/svg">
                        <path className='git-logo-path' 
                            fillRule="evenodd" 
                            clipRule="evenodd" 
                ...
                <a href="https://www.linkedin.com/in/stacy-mccarrell-71a937180/" target='_blank'>
                    <svg className='linkedin-logo'
                        xmlns="http://www.w3.org/2000/svg" 
                        width="24" height="24"
                        transform="scale(1.10)" 
                        viewBox="0 0 24 24">
                        <path className='linkedin-logo-path'
